 				...
 				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
	                <div id="remove-scroll">
	                    <ul class="sidemenu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="nav-item  ">
	                            <a  href="view-orders.php" class="nav-link "> <i class="material-icons">person</i>
	                                <span class="title">Orders</span> <span class="arrow"></span>
	                            </a>
	                        </li>
							<li class="nav-item  ">
	                            <a  href="upload-medicine.php" class="nav-link "> <i class="material-icons">person</i>
	                                <span class="title">Upload Medicine</span> <span class="arrow"></span>
	                            </a>
	                        </li>
							<li class="nav-item  open">
	                            <a  href="dispatch-medicine.php" class="nav-link "> <i class="material-icons">person</i>
